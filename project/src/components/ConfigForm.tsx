...
// import React from 'react';
// import { Settings2, Users, Target, Layout, List, Image, AlignLeft, Wand2, Zap, Presentation, Globe, FileText } from 'lucide-react';
// import type { PresentationConfig, ImageModel } from '../types';
// import { THEME_STYLES } from '../services/ai';
...
//     description: 'A comprehensive presentation on business strategy and market analysis',
//     config: {
//       topic: 'Business Strategy 2024',
//       purpose: 'business',
//       audience: 'Executive Team',
//       slideCount: 10,
//       keyPoints: ['Market Analysis', 'Competitive Landscape', 'Growth Strategy', 'Financial Projections'],
//       style: 'verdigris',
...
//   {
//     icon: '🎓',
//     title: 'Educational Course Module',
//     description: 'Perfect for creating engaging educational content',
//     config: {
//       topic: 'Introduction to Data Science',
//       purpose: 'educational',
//       audience: 'University Students',
//       slideCount: 12,
//       keyPoints: ['Basic Concepts', 'Data Analysis', 'Machine Learning', 'Real-world Applications'],
//       style: 'tranquil',
//       contentLength: 'medium',
//       imageSource: 'imagen-3-fast'
//     }
...
//     config: {
//       topic: 'Innovative Tech Startup Pitch',
//       purpose: 'business',
//       audience: 'Investors',
//       slideCount: 8,
//       keyPoints: ['Problem & Solution', 'Market Opportunity', 'Business Model', 'Financial Projections'],
//       style: 'oasis',
//       contentLength: 'brief',
//       imageSource: 'imagen-3-fast'
//     }
...
//       {/* Platform Selection */}
//       <div className="mb-12">
//         <h1 className="text-4xl font-bold text-center mb-4">Create Your Presentation</h1>
//         <div className="flex justify-center space-x-4">
//           <button className="px-6 py-3 bg-purple-600 text-white rounded-lg flex items-center space-x-2">
//             <Presentation className="w-5 h-5" />
//             <span>Presentation</span>
//           </button>
//           <button className="px-6 py-3 bg-gray-100 text-gray-600 rounded-lg flex items-center space-x-2 opacity-50 cursor-not-allowed">
...
//             <button
//               key={index}
//               onClick={() => setConfig(prompt.config)}
//               className="p-6 bg-white rounded-xl shadow-sm hover:shadow-md transition-all text-left border border-gray-200"
//             >
